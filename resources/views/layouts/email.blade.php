                            ...
                            <table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                                <tr class="mobile_only">
                                    ...
                                    <td class="w560" width="560" valign="top" align="center">
                                        <img class="mobile_only mobile-logo" border="0" src="{{asset('assets/media/logos/castellumlogo.png')}}" alt="Castellum Pro" width="150" height="" />
                                    </td>
                                    <td class="w40" width="40"></td>
                                </tr>
                            </table>
						...
						<td id="header" class="w640" align="center" width="640">
							<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
								<tr>
									...
									<td id="logo" width="580" valign="top" align="center">
										<img border="0" src="{{asset('assets/media/logos/castellumlogo.png')}}" alt="Castellum Pro" width="150" height="" />
									</td>
